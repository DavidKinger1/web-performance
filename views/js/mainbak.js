...
var pizzaContainer,             // contains pizza title, image and list of ingredients
      ...
      ul;                         // the list of ingredients    pizzaContainer = document.createElement("div");
...
function determineDx(elem, size) {
    ...
    console.log('elem.offsetWidth: ' + oldwidth);
...
function changePizzaSizes(size) {
    ...
    // Moved static calculations pizzaDiv, numPizzas, dx, and newwidth
    // out of for loop
    var pizzasDiv = document.getElementById("randomPizzas");    
    var numPizzas = document.getElementsByClassName("randomPizzaContainer").length;
...
// Moved static calculation pizzaDiv
var pizzasDiv = document.getElementById("randomPizzas");
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
    ...
    // took constant calculations of Math.sin() and made it only calculate once
    // also replaced i % 5 and made it only calculate once
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (var c = 0; c < 200; c++) {
        ...
        d.className = "mover";
        d.src = "images/pizza.png";
        d.style.height = "100px";
        d.style.width = "73.333px";
        d.basicLeft = (c % a) * b;
        d.style.top = Math.floor(c / a) * b + "px";
        document.getElementById("movingPizzas1").appendChild(d);
    }
    console.log (d);
    updatePositions()
});
